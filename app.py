...
# --- 3. ESTADOS DE SESIÓN (Inicialización Limpia) ---
    ...
    with tab1:
        ...
        if not es_nuevo:
            ...
            if res.data:
                ...
                # Sincronización de Tallas (Verificando que sea lista válida)
        ...
        with st.container(border=True):
            ...
            if suma_tizado > 0:
                ...
                if total_real != cant_pedida:
                    st.warning(f"⚠️ **Ajuste:** Para un tizado de {suma_tizado} pzs, se cortarán **{n_capas} capas** ({total_real} unidades).")
